...
Much of the interest in this trend is due to it lying at the junction of two prominent topics within the social sciences: 1) the decline of labour bargaining power, and 2) the rise in income inequality.
...
What share of aggregate income is made up by rents on housing assets and how has this evolved in recent decades? The national accounts offers three avenues for answering this question: operating surplus within the household sector ('Household sector' approach); operating surplus within the real estate industry ('Real estate industry' approach); and household final consumption of housing services ('Final consumption' approach).

Figure 1 shows the housing capital share of factor cost value added calculated according to three approaches.
