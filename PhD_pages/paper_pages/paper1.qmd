...
- Why is it that we don't have a clear view?
    ...
    2) Hampered by the available data
        ...
        - **Comparability of data** – Some secondary databases with global coverage mixes very heterogenous datapoints (WIID) (Find Atkinson and Brandolini ref from Handbook...). Those with a greater degree of harmonization tend to lack global coverage (LIS, EU-SILC, SEDLAC, until recently PIP)
...
that institutions and policies matter in shaping inequality." (WIR 2018)
            - "[Across a range of approaches] aver-
age  inequality  within  countries  increased   in  the  1990s,  but  has  been  falling  in  recent years according to most specifications." (World Bank, 2016)
