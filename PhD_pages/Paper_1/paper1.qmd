...
"Inequality defines our time" – the UN Secretary-General. (https://www.nelsonmandela.org/news/entry/annual-lecture-2020-secretary-general-guterress-full-speech)Increasing concern for inequality an increase i, researchers and institutions have responded by . In particular harmonized databases of comparable , addressing concerns (Atkinson). Both the demand to monitor inequality globally, and our ability to do so, is greater than ever.

the UN (SDGs), the World Bank and the IMF – and WID.

Yet the outcome is a mess. Contradictory messages emerge concerning the most basic descriptions from the two databases in global coverage – the *World Inequality Database*, and the World Bank's *Poverty and Inequality Platform*.

For example, different publications and studies yield starkly differing conclusions as to how widespread a phenomenon is rising inequality within countries across the world. The flagship publications from  view from *World Inequality Lab* to be taken do we live in a world in which inequality is rising in 'nearly everywhere' [@alvaredo_world_2018; @chancel_world_2021].[^WID_quotes] PIP, much more mixed. This is reflected in estimates of global inequality .

Decomposition – wthin country inequality now outweighs between country differences.
...
The first world suggests the winners from globalization and economic growth overwhelmingly and almost universally, have been a global elite. It suggestest global factors – such as capital accumulation (Piketty), over and above national policy  How to tackle inequality glboal level.
