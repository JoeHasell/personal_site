...
Their use and impact, however, has taken place within largely separate arenas. Many methodological differences separate the two datasets, including the  underlying data sources they rely on, the methods and assumptions applied to those sources, the welfare concept, the summary indices of inequality favoured, and coverage they provide. This lack of alignment between the datasets greatly limits our ability to combine the insights provided by each into a coherent empirical view informed by both. The two datasets represent distinct and, to a large extent, incommensurable 'worlds' of inequality measurement.

Moreover, these two worlds of measurement yield different views concerning the nature and evolution of inequality.

Firstly, while the *WID* data and its associated global reports suggest rising inequality was a near-ubiquitous phenomenon [@alvaredo_world_2018; @chancel_world_2021], in contrast the World Bank *PIP* data and its associated reports offer a considerably more mixed picture, in which inequality has been rising and falling in roughly equal numbers of countries [@world_bank_poverty_2016].[^WID_PIP_quotes]
...
Secondly, the datasets provide contrasting accounts as to how inequalities *within* countries compare to the differences in average incomes seen *between* countries. Most analyses of global income inequality to date have relied heavily on the *PIP* data [@Kanbur2022-lk; @lakner_global_2016; @anand_global_2015; @milanovic_global_2015; @Nino-Zarazua2017-tv; @Ravallion2014-mk]. A consistent result from these studies is that, despite recent convergence [@patel_new_2021], differences in average incomes between countries continue to make up the lion's share of global inequality. On such accounts, a person's income is largely determined by the country in which they happen to have been born [@milanovic_global_2015]. More recent analysis of the *WID* data, however, flips this established result on its head. @chancel_global_2021 find within-country inequalities instead 'dominate' inequality between countries, contributing 78% in a decompositon of the global Theil index.

Thus despite the greatly improved range of distributional data at our disposal, considerable ambiguity continues to surround some of the most basic descriptive questions concerning inequality around the world. 
