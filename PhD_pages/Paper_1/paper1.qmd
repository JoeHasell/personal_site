...
Economic inequalities around the world are vast. The world's richest 1% enjoy an average income that is around 150 times that of the poorer half of the world's population [@chancel_world_2021]. While the richest may afford private flights to space, roughly three billion people are unable to afford even just the cost of a healthy diet [@herforth_cost_2020]. 
...
Their use and impact, however, has taken place within largely separate arenas. Many methodological differences separate the two datasets, including the  underlying data sources they rely on, the methods and assumptions applied to those sources, the concept of welfare measured, the summary indices of inequality typically favoured, and coverage they provide. The two datasets represent distinct and, to a large extent, incommensurable 'worlds' of inequality measurement. This lack of alignment between the datasets limits our ability to combine the insights provided by each into a coherent empirical view informed by both.
...
The two datasets have also yielded starkly contrasting accounts of how big a contribution within-country inequalities make to overall global inequality. Most analyses of global income inequality to date have relied heavily on the *PIP* data [@kanbur_global_2022; @lakner_global_2016; @anand_global_2015; @milanovic_global_2015; @Nino-Zarazua2017-tv]. A consistent result from these studies is that, despite some recent convergence in average incomes between countries [@patel_new_2021], such differences  continue to make up the lion's share of global inequality. On such accounts, a person's income is largely determined purely by the country in which they happen to have been born [@milanovic_global_2015]. More recent analysis of the *WID* data, however, flips this established result on its head. @chancel_global_2021 find within-country inequalities instead 'dominate' inequality between countries, contributing 78% in a decompositon of the global Theil index.

The two worlds of *measurement* thus depict two very different empirical *realities*. Knowing which of these worlds we live in matters not just for our understanding of inequality today, but also our understanding of how we should seek to combat inequality in the future. A near ubiquitous rise in inequality apparent in the *WID* data points to fundamental 'forces for divergence' within capitalism [@piketty_capital_2014] and the need for global coordination, particularly on the taxation of capital, to counter them [@saez_triumph_2019]. If inequalities within countries now predominate within the global distribution of income, such avenues will also be central to tackling global inequality too [@piketty_brief_2022]. Conversely, the much more mixed picture seen in the *PIP* data highlights more prominently the past role and future scope of national policies to shape the extent of inequality within countries [@ravallion_inequality_2018]. From this viewpoint, such inequalities in any case remain a small share of overall global inequality such that the global distribution will continue to depend heavily on future aggregate growth rates [@kanbur_global_2022].

More fundamentally, the two datasets support differing narratives concerning globalization. [TODO: elabourate].

Despite laudable efforts to make transparent, in practice a black box. Treatmetn of the underlying data and assumptions. Whilst strengths and weaknesses studied for particular countries with good data, when applied globally we really don't know. Despite the great data, fundamental ambiguity surrounding the most basic aspects.

This is the first of a pair of papers that try to address this problem by bridging between the *PIP* and *WID* datasets, and the two 'worlds' of measurement they manifest. The novelty of the papers lies preciesly in considering both datasets in conjunction, in contrast to the many studies that consider only one in isolation. In taking such a combined view, we are able to 'triangulate' a more robust picture of inequality around the world by highlighting where the datasets agree and reinforce one another, and pinpointing more precisely where and why they do not.

The present paper the focuses on trends in within-country inequality. A companion paper considers overall global inequality, factoring in differences in average incomes between countries alongside the within-country inequalities analysed here. 

The rest of the paper is organized as follows. Section 2 provides a more detailed description of the *PIP* and *WID* datasets and their main differences. Section 3 compares within-country inequality trends in the two datasets, starting with the metrics where they fall furthest apart. For this we use the Gini of disposabale income (or consumption) and the top 1% share of pretax income as metrics emblematic of the *PIP* and *WID* datasets respectively.
Section 4 takes a first simple step to bridge betweent he datasets, by aligning the coverage. Section 5 considers a range of inequality indices, comparing the datasets on a like-for-like basis.
Section 5 zooms in subset of countries where there is most disagreement. the role of welfare metrics and specific data quality issues for 
Section 6 concludes, drawing out the main overlaps and disagreements between the two datasets, accounting for the steps to 
