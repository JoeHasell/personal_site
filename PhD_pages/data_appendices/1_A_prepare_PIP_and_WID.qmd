...
df_pip<- read.csv("PhD_pages/data_appendices/data/original/pip_dataset.csv")
...
write.csv(df_pip, 
      "PhD_pages/data_appendices/data/clean/pip.csv", row.names=FALSE)
...
# A local version, in case internet isn't available 
df_wid<- read.csv("PhD_pages/data_appendices/data/original/wid.csv")
...
write.csv(df_wid, 
      "PhD_pages/data_appendices/data/clean/wid.csv", row.names=FALSE)
...
df_regions<- read.csv("PhD_pages/data_appendices/data/original/WID_regions_country_standardized.csv")
...
write.csv(df_regions, 
      "PhD_pages/data_appendices/data/clean/WID_region_mapping.csv", row.names=FALSE)
...
```{python}
# df_pop.to_csv('PhD_pages/data_appendices/data/clean/population.csv')
